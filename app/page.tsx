    ...
    <>
      <main className="md:px-5 2xl:p-0 border-box flex flex-col gap-8 max-w-6xl mx-auto ">
        ...
        <section className="h-screen flex flex-col justify-center items-stretch overflow-hidden gap-20">
          <h1 className="warning-text text-wrapper font-bold text-6xl text-center">
        ...
        <section className="h-full flex flex-col items-center justify-start gap-10 md:py-20">
          ...
          <div className="flex flex-col md:flex-row gap-10 justify-start items-center">
            <div className="w-1/2 md:flex-1">
              <img
                className="object-cover shadow-card rounded-xl"
                src="https://i.ibb.co.com/5s8TYhT/foto-bebas.jpg"
                alt="profile pic"
              />
            </div>
            <div className="p-5 flex-1 flex flex-col gap-10 items-center">
              ...
              <p className="text-xl">
                Currently studying for a Bachelor&apos;s degree in Informatics,
                computer science.
              </p>
              <p className="text-xl">
                I wake up in the morning, grab a cup of timmies coffee, open up
                my laptop and build things that live on the web all day,
                everyday.
              </p>
              <p className="text-xl">
                People who know me say I&apos;m obsessed, that&apos;s fair, I am
                very driven and love learning new things.
              </p>
              <Link href="/about">
                <Button size="big">
                  More About Me
        ...
        <section className="h-full flex flex-col items-center justify-start relative">
          <div>
            ...
            <div className="mt-5 flex gap-4 flex-wrap justify-center">
              <Button
                onClick={() => {
                  handleFilterChange("appDev");
                }}
                style={filter === "appDev" ? "bg-white text-black" : ""}
                size="small"
              >
              ...
              <Button
                ...
                size="small"
                style={filter === "uiuxDesigner" ? "bg-white text-black" : ""}
              >
          ...
          <h3 className="mt-12 mb-6 flex text-3xl font-bold items-center gap-1">
            <HiSparkles />
            My Top Three {filter === "appDev"
              ? "Programming"
              : "UI/UX Design"}{" "}
            Pieces
            <HiSparkles />
            ...
            {filteredProjects.map((item) => (
              <Link key={item._id} href={item.urlToProject}>
                <div className="flex flex-col items-center">
                  <div className="card_container group relative mt-5 w-full aspect-[3/5] overflow-hidden rounded-lg">
                    <img
                      ...
                      alt={item.title}
                    />
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity text-white flex flex-col justify-center p-5 text-background absolute inset-0 bg-black/70 gap-5">
          ...
          <Button size="big">
            <Link href="/portfolio">More of My Projects</Link>
            <HiArrowNarrowRight />{" "}
          </Button>
        </section>
      </main>
